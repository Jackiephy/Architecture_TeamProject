	   ...
	   private void initComponents()
	    {
	          ...
	          label_instruction=new JLabel("Float/Vector Test:");
	          label_instruction.setBounds(10, 44, 120, 25);
	          FloatAdd_Button=new JButton("Float Add/Sub");
	          FloatAdd_Button.setBounds(125, 35, 115, 40);
	          FloatConver_Button=new JButton("Float Conver");
	          FloatConver_Button.setBounds(240, 35, 115, 40);
	          VectorAdd_Button=new JButton("Vector Add");
	          VectorAdd_Button.setBounds(355, 35, 100, 40);
	          VectorSub_Button=new JButton("Vector Sub");
	          VectorSub_Button.setBounds(455, 35, 100, 40);
...
//	          }
	          panel_control.add(FloatAdd_Button);
	          panel_control.add(FloatConver_Button);
	          panel_control.add(VectorAdd_Button);
	          panel_control.add(VectorSub_Button);
...
//	          button_execute.setEnabled(false);
	          ...
	          FloatAdd_Button.setEnabled(false);
	          FloatConver_Button.setEnabled(false);
	          VectorAdd_Button.setEnabled(false);
	          VectorSub_Button.setEnabled(false);
...
//	        button_execute.setEnabled(true);
	        ...
	        FloatAdd_Button.setEnabled(true);
	        FloatConver_Button.setEnabled(true);
	        VectorAdd_Button.setEnabled(true);
	        VectorSub_Button.setEnabled(true);
	   ...
	   public void refreshPanel(){
	        for (Component com : panel_console.getComponents()) {
